    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent histIntent = new Intent(history.this, MainActivity.class);
...
//        Code for Book History of admin application
        ...
        aHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(history.this, "You are viewing this page", Toast.LENGTH_SHORT).show();
...
//       redirecting to Admin setting page
        ...
        aSetting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent settingIntent = new Intent(history.this,adminSetting.class);
